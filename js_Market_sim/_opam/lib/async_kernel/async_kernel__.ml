...
(** @canonical Async_kernel.Cycle_hook *)
module Cycle_hook = Async_kernel__Cycle_hook
...
(** @canonical Async_kernel.Deferred_memo_intf *)
module Deferred_memo_intf = Async_kernel__Deferred_memo_intf
...
(** @canonical Async_kernel.Deferred_set *)
module Deferred_set = Async_kernel__Deferred_set
...
(** @canonical Async_kernel.Throttled *)
module Throttled = Async_kernel__Throttled
...
module Async_kernel__ = struct end
